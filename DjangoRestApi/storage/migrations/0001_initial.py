...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter the name for thematic page', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Upload',
            fields=[
                ...
                ('thematic_page', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='storage.thematicpage')),
